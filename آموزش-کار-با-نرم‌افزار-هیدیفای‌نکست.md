...
<details markdown="1"> <summary><b>نصب روی ویندوز (کلیک کنید)</b></summary>
...
یعنی دسترسی x یا اجرایی را دارد و می‌توانید آن را به راحتی اجرا نمایید. اگر دست در غیر این صورت برای افزودن دسترسی اجرای می‌توانید دستور زیر را در ترمینال اجرا نمایید.
