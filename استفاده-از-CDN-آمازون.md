...
# استفاده از CDN آمازون یا Cloudfrant
## ثبت دامنه
*  DNS برای این کار ابتدا یک رکورد A به آدرس سرور خود پوینت می‌کنیم. فزضا `sub1.domain.com` را به آدرس ایپی سرور خود پوینت کرده‌ایم.
...
در واقع این ساب‌دامنه برای دامنه CDN مورد نظر ما استفاده خواد شد.
...
* به نحل ثبت رکوردهای DNS خود (فرضا کلادفلر) بروید و یک رکورد Cname name ایجاد نمایید و مقادیری که در مرحله قبل در AWS داشتید را وارد نمایید. در کلادفلر به جای name مقدار Cname و به جای تارگت مقداری Cname value را وارد کنید.
