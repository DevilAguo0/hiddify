...
## چرا با وجود فعال‌سازی پروتکل ریلیتی در منوی پروکسی‌ها این کانفیگ‌ها را نمی‌بینم؟

اگر با وجود فعال کردن پروتکل Reality در قسمت پروکسی‌ها همچنان این کانکشن‌ها را در لیست کانفیگ‌ها نمی‌بینید نیاز است به تنظیمات دامنه سابسکریپشن بروید و دامنه دایرکت خود را به آن دامنه اضافه نمایید. فرض کنید دامنه سابسکریپشن شما `t1.hiddify.com` باشد و لینک دایرکت شما نیز `t2.hiddify.com` باشد. شما نیاز است در تنظیمات دامنه `t1.hiddify.com` بروید و در فیلد نمایش کانفیگ‌های دامنه؛ تیک دامنه `t2.hiddify.com` را بزنید. حالا اگه لینک سابسکریپشن خود که روی دامنه `t1.hiddify.com` است را باز کنید؛ مشاهده خواهید کرد که کانفیگ‌های Reality وجود دارند. 
