...
Reality یکی از پروتکل‌های جدید ارائه شده توسطXray پایه‌گذاری شده است، که پیش‌نیازهای پروتکل‌های قبلی را ندارد. این پروتکل بر مبنای Vless می‌باشد بنابراین برای Vmess یا Trojan قابل استفاده نیست. در هیدیفای همچنان تاکید بر ساده‌سازی بوده است بنابراین بخش اعظم کار در پشت زمینه انجام می‌شود.
