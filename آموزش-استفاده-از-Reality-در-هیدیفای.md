...
![](https://user-images.githubusercontent.com/125398461/235887876-02c57860-3038-4718-bde1-8b85a3a4c6bd.png)

فرض کنید دامنه سابسکریپشن شما `t1.hiddify.com` باشد و لینک دایرکت شما نیز `direct.hiddify.com` باشد. شما نیاز است در تنظیمات دامنه `t1.hiddify.com` بروید و در فیلد `نمایش کانفیگ‌های دامنه`؛ تیک دامنه `direct.hiddify.com` را بزنید. حالا اگه لینک سابسکریپشن خود که روی دامنه `t1.hiddify.com` است را باز کنید؛ مشاهده خواهید کرد که کانفیگ‌های Reality وجود دارند. 
